...
- Cu 6 GeV wznowione od grubości 28.4 cm (do 30.0 cm)
- Pozostałe elementy do skończenia: Pb od 0.1, 30.0 dla energii 2 i 3 GeV.
...
JOBS = []
# Cu @ 6 GeV zrobione do 28.3 -> grubość 28.3 cm, wznawiamy od 28.4 cm:
JOBS.append(("G4_Cu", "Cu", "6 GeV", 28.4, 30.0))

# Ołów (Pb) normalnie od 0.1 do 30 cm tylko dla 2 GeV i 3 GeV:
for e in [2, 3]:
